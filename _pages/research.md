...
![]({{ site.url }}{{ site.baseurl }}/images/research/freed-vision.jpg){: style="width: 250px; float: left; margin: 0px  10px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/research/wrel-bulb.jpg){: style="width: 250px; float: left; margin: 0px  10px"}
